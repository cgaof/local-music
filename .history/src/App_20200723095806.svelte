<div class="body">
	...
	<audio id="audio_id" poster="http://img.lanrentuku.com/img/allimg/1810/15409966139768.jpg" controls autoplay on:ended={handleMusicEnded}>Your browser can't support HTML5 Audio</audio>
	<h2 id="name">{name}</h2>
	<button id="next" on:click={handleChangeMusic}>next</button>
</div>
<script>
      const audioDom = document.getElementById('audio_id');
      let name = "cc";
      const audioList = [];
			let audioIdx = 0;
