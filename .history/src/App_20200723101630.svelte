<div class="body">
	...
	<audio id="audio_id" bind:this={audioDom} poster="http://img.lanrentuku.com/img/allimg/1810/15409966139768.jpg" controls autoplay on:ended={handleMusicEnded} bind:src={src}>Your browser can't support HTML5 Audio</audio>
	<h2 id="name">{name}</h2>
